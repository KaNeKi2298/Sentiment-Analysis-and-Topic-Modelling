...
def get_header(asin):
    try:
        global headers
        ratings_dict = {}
        amazon_url = 'https://www.amazon.in/Samsung-Display-Storage-6000mAH-Battery/product-reviews/' + asin + '/ref=cm_cr_arp_d_paging_btm_next_1?ie=UTF8&reviewerType=all_reviews&pageNumber=1'
...
def get_all_reviews(asin):
    ...
    for page_number in range(1, 100):
        amazon_url = 'https://www.amazon.in/Samsung-Display-Storage-6000mAH-Battery/product-reviews/' + \
                     asin + \
